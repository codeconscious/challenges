...
public class AlphabeticNumberPuzzleSolver : IRunnable
{
    ...
    /// <summary>
    /// Calculates the answer to the given word problem.
    /// </summary>
    /// <remarks>This is fairly messy as there was some time pressure.</remarks>
                                  ...
                                  params string[] rawWords)
    {
        ...
        var distinctLetterCount = distinctLetters.Count();
